...
L["uplp_weapon_auto5_desc"] = "Auto-5 Repeater är en halvautomatisk hagelgevär känt för sin karakteristiska högbuckliga mottagardesign, som minskar rekyl genom att leda pipans rekylrörelse i linje med skyttens axel. Det var ett populärt val för jägare och sportskyttar under större delen av 1900-talet."
...
L["uplp_weapon_corvo_desc"] = "Prickskyttegeväret Eclipse MK-V är känt för sin exceptionella precision och mångsidighet. Den har en modulär design, avancerade material och anpassningsbar kaliber, vilket gör det till ett populärt val bland professionella prickskyttar för dess förmåga att leverera exakta skott på långt avstånd i olika taktiska situationer."

L["uplp_weapon_corvo_real"] = "Victrix Corvo V"

//////////////////// FAMAS Valorisé -- Needs more work.
L["uplp_weapon_famas"] = "Valorisé"
L["uplp_weapon_famas_desc"] = "Valorisé är en fransk automatkarbin som är en uppgraderad version av den ursprungliga Épèiste F1. Den har olika förbättringar, som en Picatinny-skena för att fästa tillbehör och en förstorad varbygel för enkel användning med handskar, vilket ökar dess mångsidighet och anpassningsförmåga för moderna militära och rättshandhavandekrav."

L["uplp_weapon_famas_real"] = "FAMAS Valorisé"

//////////////////// G36
L["uplp_weapon_g36"] = "Sturmgewehr Modell 95"
L["uplp_weapon_g36_desc"] = "Sturmgewehr Modell 95, en selektiveldsgevär, är känt för sin modulära design och pålitlighet, och erbjuder både halvautomatiska och helt automatiska eldlägen. Den föredras av olika militära och polisiära enheter över hela världen för sin precision och mångsidighet i olika stridssituationer."

L["uplp_weapon_g36_real"] = "H&K G36"

//////////////////// GSh-18
L["uplp_weapon_gsh18"] = "Polnoch 95"
L["uplp_weapon_gsh18_desc"] = "Polnoch 95 är en rysk halvautomatisk pistol avsedd för militärt och polisiärt bruk. Den är känd för sin unika mekanism med enbart double-action-avfyrningsmekanism samt sitt högkapacitetsmagasin, som vanligtvis rymmer 18 patroner av kaliber 9x19 mm."

L["uplp_weapon_gsh18_real"] = "GSh-18"

//////////////////// IMI Galil
L["uplp_weapon_galil"] = "Tjänstgevär 72"
L["uplp_weapon_galil_desc"] = "Tjänstgevär 72 är ett israeliskt tillverkat automatgevär känt för sin pålitlighet och mångsidighet. Det designades för att vara robust och effektiv i olika stridssituationer och har använts av Israel Defense Forces och många andra militära och polisiära enheter runt om i världen."

L["uplp_weapon_galil_real"] = "IMI Galil"

//////////////////// KAC SRR
L["uplp_weapon_srr"] = "Revolver Rifle S"
L["uplp_weapon_srr_desc"] = "Revolver Rifle S är en unik eldhandvapen som kombinerar egenskaperna hos en revolver med en karbin, och är utrustad med en ljuddämpare för minskat ljud, vilket gör den mångsidig för specialoperationer och diskret skjutning."

L["uplp_weapon_srr_real"] = "KAC SRR"

//////////////////// B&T KH9
L["uplp_weapon_kh9"] = "Maschinenpistole 20"
L["uplp_weapon_kh9_desc"] = "KH9 är en kompakt kulsprutepistol som är känd för sin enastående byggkvalitet och funktioner, vilket gör den till ett populärt val bland militär och polis samt civila vapenentusiaster."

L["uplp_weapon_kh9_real"] = "B&T KH9"

//////////////////// Colt M1911
L["uplp_weapon_m1911"] = "Military 45"
L["uplp_weapon_m1911_desc"] = "Military 45, en klassisk halvautomatisk pistol, är känd för sin tidlösa design och sin långa tjänstehistoria, som först togs i bruk av den amerikanska militären 1911. Den har sedan dess blivit en ikonisk och allmänt använd pistol, uppskattad för sin kaliber .45 Auto och gedigna konstruktion."

L["uplp_weapon_m1911_real"] = "Colt M1911"

//////////////////// SWORD MK-18 Mjölnir
L["uplp_weapon_mjolnir"] = "Mjölnir"
L["uplp_weapon_mjolnir_desc"] = "Mjölnir är ett toppmodernt gevär känt för sin MK-18-beteckning, med avancerad teknik och modulär design för mångsidighet i olika taktiska situationer. Den har blivit populär bland militära och polisiära enheter tack vare sin prestanda och anpassningsbarhet."

L["uplp_weapon_mjolnir_real"] = "SWORD MK-18 Mjölnir"

//////////////////// MP 3008
L["uplp_weapon_mp3008"] = "MP 3008"
L["uplp_weapon_mp3008_desc"] = "MP 3008, även känt som Gerät Neumünster, var en tysk kulsprutepistol som utvecklades under andra världskriget. Det var en enkel och kostnadseffektiv konstruktion inspirerad av den brittiska Sten-pistolen och avsedd för hemlig användning av tyska styrkor under kriget."

L["uplp_weapon_mp3008_real"] = "MP 3008"

//////////////////// SG 552
L["uplp_weapon_sg552"] = "Gewehr 500"
L["uplp_weapon_sg552_desc"] = "Gewehr 500 är ett välkänt automatgevär med en kompakt design, känt för sin pålitlighet och anpassningsbarhet. Det har antagits av olika militära och polisiära enheter över hela världen tack vare dess prestanda och mångsidighet i olika stridssituationer."

L["uplp_weapon_sg552_real"] = "SIG SG 552"

//////////////////// SR-3 Vikhr
L["uplp_weapon_sr3"] = "CP-3"
L["uplp_weapon_sr3_desc"] = "CP-3 är en kompakt rysk kulsprutepistol avsedd för specialstyrkor och polisenheter. Den är mycket uppskattad för sin kompakta storlek, låg rekyl och förmågan att avfyra pansarbrytande ammunition, vilket gör den effektiv i närstridssituationer."

L["uplp_weapon_sr3_real"] = "SR-3 Vikhr"

//////////////////// Serbu Super-Shorty
L["uplp_weapon_shorty"] = "Dörrbrytaren"
L["uplp_weapon_shorty_desc"] = "Dörrbrytaren är en kompakt och kraftigt kapat hagelgevär som är känt för sin extremt korta längd och portabilitet. Ursprungligen baserad på en välkänd pumprepeter vilket gör att den används främst för självförsvarssyften på korta avstånd."
...
L["uplp_weapon_xcrm_desc"] = "RAWR-M är ett mångsidigt och modulärt halvautomatiskt gevär känt för sin förmåga att snabbt växla mellan olika kalibrar och konfigurationer. Utformat för både militärt och civilt bruk, erbjuder det anpassningsbarhet och enkelhet i anpassning för att passa olika behov."
