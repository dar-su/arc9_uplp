...
L["uplp_optic_dcl110.description"] = "Крупный и громоздкий коллиматорный прицел с встроенным магнифером, предназначенным для пулемётов. Вы уверены, что хотите его установить? Ваша пушка не похожа на пулёмет! (если только это не ПС 7.62)" .. desc_magoptic
