...
SWEP.WorldModelOffset = {
    ...
    TPIKHolsterOffset = Vector(7, -0.5, -6),
}
...
-- Damage
SWEP.DamageMax = 100 * ARC9.UPLP_ShotgunDamageMaxModifier
...
SWEP.SpeedMultShooting = 0.7 -- big fuck-all shell eh
