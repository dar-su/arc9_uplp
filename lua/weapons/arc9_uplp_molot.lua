...
SWEP.AttachmentElements = {
    ...
    ["uplp_molot_brl_long"] =   { Bodygroups = { { 2, 1 } } },
    ["uplp_molot_brl_compact"] ={ Bodygroups = { { 2, 2 } } },
    ["uplp_molot_brl_mini"] =   { Bodygroups = { { 2, 3 } } },
    ["uplp_molot_brl_micro"] =  { Bodygroups = { { 2, 4 } } },
