...
SWEP.Credits = {
    ...
    [ ARC9:GetPhrase( "uplp_animations" ) ] = "Cylo",
...
SWEP.DryFireSound = ")uplp_urban_temp/ak/" .. "dryfire.wav"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "chback.ogg", t = 5 / 30, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 11.5 / 30, v = 0.8 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            { s = UTCrattle, t = 0, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 0, v = 0.9 },
    ...
    ["reload_long"] = {
        ...
        EventTable = {
            { s = UTCrattle, t = 0, v = 0.8 },
            { s = pathUT .. "magout.ogg", t = 12 / 30, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 24 / 30, v = 0.9 },
            { s = pathUT .. "magin.ogg", t = 45 / 30, v = 0.8 },
            { s = UTCrattle, t = 63 / 30, v = 0.4 },
            {hide = 2, t = 0},
            {hide = 3, t = 0.75},
            {hide = 2, t = 1.1},
        },
    ...
    ["reload_empty_long"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch.ogg", t = 24 / 30, v = 0.9 },
            { s = pathUT .. "magin.ogg", t = 45 / 30, v = 0.8 },
            { s = pathUT .. "chback.ogg", t = 67 / 30, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 71 / 30, v = 0.8 },
            { s = UTCrattle, t = 77 / 30, v = 0.4 },
            {hide = 2, t = 0},
            {hide = 3, t = 0.75},
            {hide = 2, t = 1.1},
        },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            { s = UTCrattle, t = 0, v = 0.8 },
            { s = "uplp_rz/ak/magrel.ogg", t = 7 / 30, v = 0.8 },
            { s = pathUT .. "magout.ogg", t = 18 / 30, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 40 / 30, v = 0.9 },
            { s = pathUT .. "magin.ogg", t = 63 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/ak/bonk.ogg", t = 80 / 30, v = 0.8 },
            { s = UTCrattle, t = 87 / 30, v = 0.5 },
    ...
    ["reload_empty_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin.ogg", t = 63 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/ak/bonk.ogg", t = 80 / 30, v = 0.8 },
            { s = pathUTC .. "movement-shotgun-04.ogg", t = 87 / 30 },
