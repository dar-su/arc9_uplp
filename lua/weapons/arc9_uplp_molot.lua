...
-- Damage
SWEP.DamageMax = 30 * ARC9.UPLP_ShotgunDamageMaxModifier
SWEP.DamageMin = 12 * ARC9.UPLP_ShotgunDamageMinModifier
...
SWEP.BodyDamageMults = {
    [HITGROUP_HEAD] = 1.5, -- When using HullSize, body damage mults cannot apply! really?
    [HITGROUP_CHEST] = 1,
    [HITGROUP_STOMACH] = 1,
    [HITGROUP_LEFTARM] = 1,
    [HITGROUP_RIGHTARM] = 1,
...
-- Physical Bullets
SWEP.PhysBulletMuzzleVelocity = 340 / ARC9.HUToM
...
SWEP.VisualRecoilUpHipFire = 7
SWEP.VisualRecoilSideHipFire = -0.5
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin.ogg", t = 34 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 50 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.25},
            {hide = 2, t = 0.86},
        },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 13 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magin.ogg", t = 34 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chback.ogg", t = 53 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 57 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 65 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.25},
            {hide = 2, t = 0.86},
        },
    ...
    ["reload_long"] = {
        ...
        EventTable = {
            { s = UTCrattle, t = 0 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magout.ogg", t = 12 / 30, c = ca, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 24 / 30, v = 0.9 },
            { s = pathUT .. "magin.ogg", t = 45 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 63 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.58},
            {hide = 2, t = 1.35},
        },
    ...
    ["reload_empty_long"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch.ogg", t = 24 / 30, v = 0.9 },
            { s = pathUT .. "magin.ogg", t = 45 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chback.ogg", t = 67 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 71 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 77 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.58},
            {hide = 2, t = 1.35},
        },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            { s = UTCrattle, t = 0 / 30, c = ca, v = 0.8 },
            { s = "uplp_rz/ak/magrel.ogg", t = 7 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magout.ogg", t = 18 / 30, c = ca, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 40 / 30, v = 0.9 },
            { s = pathUT .. "magin.ogg", t = 63 / 30, c = ca, v = 0.8 },
            { s = ")uplp_urban_temp/ak/bonk.ogg", t = 80 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 87 / 30, c = ca, v = 0.5 },
    ...
    ["reload_empty_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin.ogg", t = 63 / 30, c = ca, v = 0.8 },
            { s = ")uplp_urban_temp/ak/bonk.ogg", t = 80 / 30, c = ca, v = 0.8 },
            { s = pathUTC .. "movement-shotgun-04.ogg", t = 87 / 30, c = ca },
            { s = pathUTC .. "cloth_2.ogg", t = 98 / 30, c = ca , v = 0.6},

            { s = pathUT .. "chback.ogg", t = 113 / 30, c = ca, v = 0.9 },
            { s = pathUT .. "chamber.ogg", t = 118 / 30, c = ca, v = 1 },
            { s = UTCrattle, t = 126 / 30, c = ca, v = 0.45 },
