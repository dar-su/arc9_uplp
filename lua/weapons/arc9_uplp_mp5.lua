...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUTREAL .. "slap.ogg", t = 9 / 30, v = 0.75 },
            { s = pathUTC .. "cloth_4.ogg", t = 9 / 30, v = 0.8 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.15, lhik = 0 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 0.25*0.9 - 0.15, v = 0.8 },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 0.5*0.9, v = 0.6 },
            { s = pathUT .. "magin.ogg", t = 0.8, v = 0.8 },
            -- { s = pathUT .. "magtap.ogg", t = 1.05*0.9 - 0.035, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 1.2*0.9, v = 0.8 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            { s = pathUTC .. "rattle2.ogg", t = 0, v = 0.8 },
            { s = pathUT .. "chback.ogg", t = 0, v = 0.8 },
            { s = pathUT .. "chlock.ogg", t = 0.3, v = 0.8 },

            { s = pathUT .. "magout.ogg", t = 0.73 - 0.15, v = 0.8 },
    ...
    ["reload_15"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 0.25*0.9 - 0.15, v = 0.8 },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 0.5*0.9, v = 0.6 },
            -- { s = pathUT .. "magin.ogg", t = 1.03, v = 0.8 },
            { s = pathUT .. "magtap.ogg", t = 1.05*0.9 - 0.035 - 0.125, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 1.2*0.9 - 0.125, v = 0.8 },
    ...
    ["reload_empty_15"] = {
        ...
        EventTable = {
            { s = pathUTC .. "rattle2.ogg", t = 0, v = 0.8 },
            { s = pathUT .. "rack1.ogg", t = 0.2, v = 0.8 },
            { s = pathUT .. "chlock.ogg", t = 0.3, v = 0.8 },
    ...
    ["reload_50"] = {
        ...
        EventTable = {
            { s = pathUTC .. "rattle2.ogg", t = 0, v = 0.8 },
            { s = pathUT .. "magout.ogg", t = 0.25*0.9 - 0.1, v = 0.8 },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 0.5*0.9, v = 0.6 },
            { s = pathUT .. "magin.ogg", t = 0.8, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 1.25, v = 0.8 },
    ...
    ["reload_empty_50"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 0.7, v = 0.8 },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 1.0, v = 0.6 },
            { s = pathUT .. "magin.ogg", t = 1.3, v = 0.8 },
            { s = pathUTC .. "cloth_1.ogg", t = 1.65, v = 0.5 },
            { s = pathUTREAL .. "slap.ogg", t = 2.2, v = 0.75 },
            { s = pathUTC .. "cloth_4.ogg", t = 2.2, v = 0.8 },
    ...
    ["reload_empty_catch"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "chlock.ogg", t = 1.3, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 1.4, v = 0.8 },

            { s = pathUTC .. "cloth_4.ogg", t = 1.45, v = 0.8 },
    ...
    ["firemode_1"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "selector-01.ogg", t = 5 / 30, v = 0.8 },
        },
    },
    ["firemode_2"] = {
        Source = "firemode_2",
        EventTable = {
            { s = pathUTC .. "movement-rifle-02.ogg", t = 0, v = 0.2 },
            { s = pathUT .. "selector-02.ogg", t = 5 / 30, v = 0.8 },
        },
    },
    ["firemode_3"] = {
        Source = "firemode_3",
        EventTable = {
            { s = pathUTC .. "movement-rifle-02.ogg", t  = 0, v = 0.2 },
            { s = pathUT .. "selector-03.ogg", t = 7 / 30, v = 0.8 },
        },
    },
