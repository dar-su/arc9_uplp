...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "chback_9.ogg", t = 4.5 / 30, v = 0.8 },
            { s = pathUT .. "chamber_9.ogg", t = 9 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 30 / 60 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.01, lhik = 0 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "movement-smg-04.ogg", t = 13 / 30, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 10 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/magout.ogg", t = 12 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/magtap.ogg", t = 27.5 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 41 / 30, v = 0.8 },
            {hide = 2, t = 0},
            {hide = 0, t = 0.2},
            {hide = 1, t = 21/30}
        },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_urban_temp/mp7/magout.ogg", t = 12 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/magtap.ogg", t = 27.5 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-01.ogg", t = 31 / 30, v = 0.8 },
            { s = pathUT .. "chback_9.ogg", t = 39 / 30, v = 0.8 },
            { s = pathUT .. "chamber_9.ogg", t = 46 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 52 / 30, v = 0.8 },
            {hide = 2, t = 0},
            {hide = 0, t = 0.2},
            {hide = 1, t = 21/30}
        },
    ...
    ["reload_bizon"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 0.0, v = 0.6 },
            { s = pathUTC .. "cloth_5.ogg", t = 0, v = 0.5 },
            { s = pathUT .. "magrelease.ogg", t = 7 / 30, v = 0.6 },
            { s = pathUTC .. "magpouch.ogg", t = 9 / 30, v = 0.7 },
            { s = pathUTC .. "cloth_2.ogg", t = 12 / 30, v = 0.7 },
            { s = pathUTC .. "cloth_6.ogg", t = 17 / 30, v = 0.85 },
            { s = pathUT .. "bonk.ogg", t = 19 / 30, v = 0.95 },
            { s = pathUT .. "magout.ogg", t = 20 / 30, v = 0.8 },
            { s = pathUT .. "magin_308.ogg", t = 34 / 30, v = 0.9 },
            { s = pathUTC .. "grab.ogg", t = 37 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-03.ogg", t = 46 / 30, v = 0.7 },
    ...
    ["reload_empty_bizon"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin_308.ogg", t = 34 / 30, v = 0.9 },
            { s = pathUTC .. "grab.ogg", t = 37 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 48 / 30, v = 0.7 },
            { s = pathUT .. "chback_9.ogg", t = 52 / 30, v = 0.8 },
            { s = pathUT .. "chamber_9.ogg", t = 57 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 65 / 30, v = 0.8 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magrelease.ogg", t = 84 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/magout.ogg", t = 87 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_2.ogg", t = 24 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_5.ogg", t = 54 / 30, v = 0.65 },
            { s = pathUTC .. "grab-polymer.ogg", t = 65 / 30, v = 0.5 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 93 / 30, v = 0.65 },
            { s = ")uplp_urban_temp/mp7/magin.ogg", t = 155 / 30, v = 0.9 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 180 / 30, v = 0.8 },
            {hide = 2, t = 0},
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
    ...
    ["inspect_bizon"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "movement-rifle-02.ogg", t = 59 / 30, v = 0.8 },
