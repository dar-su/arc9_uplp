...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 11 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 18 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 35.5 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 42 / 30, c = ca, v = 0.8 },
    ...
    ["reload_empty_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chforward.ogg", t = 45.5 / 30, c = ca, v = 0.8 },
    ...
    ["reload_empty_545"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chforward.ogg", t = 40 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 50 / 30, c = ca, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
    ...
    ["reload_empty_545_60rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 11 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 21 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 43.5 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 47 / 30, c = ca, v = 0.8 },
