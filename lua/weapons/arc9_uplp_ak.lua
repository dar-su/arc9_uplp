...
SWEP.IronSightsHook = function(self) -- If any attachments equipped should alter Irons
    ...
    if attached["uplp_ak_brl_su"] then
        return is_su
    elseif attached["uplp_ak_brl_109"] then
        return is_109
    end
end
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 8 / 30, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 14 / 30, v = 0.8 },
    ...
    ["ready_308"] = {
        ...
        EventTable = {
            { s = pathUTC .. "cloth_3.ogg", t = 0, v = 0.8 },
            { s = pathUTC .. "raise.ogg", t = 2 / 30, v = 0.8 },
            { s = pathUT .. "chback_308.ogg", t = 6 / 30, v = 0.8 },
            { s = pathUT .. "chamber_308.ogg", t = 12 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 35 / 60 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magrelease.ogg", t = 6 / 30, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 7 / 30, v = 0.6 },
            { s = pathRZ .. "magout.ogg", t = 8 / 30 },
            { s = pathUT .. "magin.ogg", t = 21 / 30, v = 0.8 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 8 / 30 },
            { s = pathUT .. "magin.ogg", t = 21 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 41 / 30, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 48 / 30, v = 0.8 },
            { s = UTCrattle, t = 56 / 30, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magrelease.ogg", t = 9 / 30 + 6 / 30, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 11 / 30 + 6 / 30 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30 },
    ...
    ["reload_empty_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30 },
            { s = pathUT .. "magin.ogg", t = 22 / 30 + 8 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 42 / 30 + 8 / 30, v = 0.8 },
    ...
    ["reload_545"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 0.0, v = 0.9 },
            { s = pathUT .. "reload_start.ogg", t = 0.025, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 9 / 30, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 11 / 30 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30 },
    ...
    ["reload_empty_545"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 },
            { s = pathUT .. "magin.ogg", t = 22 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 42 / 30, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 49 / 30, v = 0.8 },
            { s = UTCrattle, t = 56 / 30, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
    ...
    ["reload_empty_545_60rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30 },
            { s = pathUT .. "magin.ogg", t = 22 / 30 + 10 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 42 / 30 + 10 / 30, v = 0.8 },
    ...
    ["reload_drum"] = {
        ...
        -- DropMagAt = 0.75,
        EventTable = {
            { s = pathUT .. "reload_start.ogg", t = 0, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 10 / 30 },
            { s = pathUT .. "magout_drum.ogg", t = 13 / 30 },
            { s = pathUTC .. "magpouch.ogg", t = 25 / 30, v = 0.8 },
            { s = pathUT .. "magin_drum.ogg", t = 37 / 30 },
            { s = pathUT .. "bonk.ogg", t = 68 / 30 },
            { s = UTCrattle, t = 79 / 30, v = 0.8 },
            -- {hide = 1, t = 0},
            -- {hide = 0, t = 0.3},
            -- {hide = 2, t = 0.85}
        },
    ...
    ["reload_empty_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch.ogg", t = 25 / 30, v = 0.8 },
            { s = pathUT .. "magin_drum.ogg", t = 37 / 30 },
            { s = pathUTC .. "cloth_4.ogg", t = 65 / 30, v = 0.75 },
            { s = pathRZ .. "chback.ogg", t = 74 / 30, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 78 / 30, v = 0.8 },
    ...
    ["reload_empty_308"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30 },
            { s = pathUT .. "magin_308.ogg", t = 22 / 30 + 8 / 30, v = 0.8 },
            { s = pathUT .. "chback_308.ogg", t = 42 / 30 + 6 / 30, v = 0.8 },
    ...
    ["inspect_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "movement-rifle-03.ogg", t = 5 / 30, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 10 / 30, v = 0.8 },
            { s = pathUT .. "magout_drum.ogg", t = 12.5 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_2.ogg", t = 48 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 54 / 30, v = 0.8 },
            { s = pathUT .. "scrape.ogg", t = 70 / 30 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 80 / 30, v = 0.8 },
            { s = pathUT .. "magin_drum.ogg", t = 122.5 / 30, v = 0.8 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.15, lhik = 0 },
    ...
    ["inspect_308"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "cloth_2.ogg", t = 44 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 50 / 30, v = 0.8 },
            { s = pathUT .. "grab.ogg", t = 63 / 30 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 80 / 30, v = 0.8 },
            { s = pathUT .. "magin_308.ogg", t = 115 / 30, v = 0.8 },
            {hide = 1, t = 0},
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
