...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 8 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 14 / 30, c = ca, v = 0.8 },
    ...
    ["ready_308"] = {
        ...
        EventTable = {
            { s = pathUTC .. "cloth_3.ogg", t = 0 / 30, c = ca, v = 0.8 },
            { s = pathUTC .. "raise.ogg", t = 2 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chback_308.ogg", t = 6 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chamber_308.ogg", t = 12 / 30, c = ca, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 35 / 60, c = ca },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 11 / 30, c = ca, v = 1 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 36 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 42 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 49 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 56 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_40rnd"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 0.0, v = 0.9 },
            { s = pathUT .. "reload_start.ogg", t = 0.025 + 1 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 9 / 30 + 6 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 11 / 30 + 6 / 30, c = ca, v = 1 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30 + 8 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 36 / 30 + 8 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_empty_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30 + 8 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 42 / 30 + 8 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 49 / 30 + 8 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 56 / 30 + 8 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_545_60rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 11 / 30 + 6 / 30, c = ca, v = 1 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30 + 10 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 36 / 30 + 10 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_empty_545_60rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30 + 10 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 42 / 30 + 10 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 49 / 30 + 10 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 56 / 30 + 10 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin_drum.ogg", t = 37 / 30, c = ca, v = 1 },
    ...
    ["reload_empty_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 74 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 78 / 30, c = ca, v = 0.8 },
    ...
    ["reload_308"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 11 / 30 + 6 / 30, c = ca, v = 1 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin_308.ogg", t = 22 / 30 + 8 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 36 / 30 + 8 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
    ...
    ["reload_empty_308"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 12 / 30 + 7 / 30, c = ca, v = 1 },
            { s = pathUT .. "magin_308.ogg", t = 22 / 30 + 8 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chback_308.ogg", t = 42 / 30 + 6 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "chamber_308.ogg", t = 49 / 30 + 6 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 56 / 30 + 8 / 30, c = ca, v = 0.4 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
