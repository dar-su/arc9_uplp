...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 11 / 30, v = 1 },
            { s = pathRZ .. "magout.ogg", t = 12 / 30, v = 1 },
    ...
    ["reload_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 11 / 30 + 6 / 30, v = 1 },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout_drum.ogg", t = 13 / 30, v = 1 },
            { s = pathUTC .. "magpouch.ogg", t = 25 / 30, v = 0.8 },
            { s = pathUT .. "magin_drum.ogg", t = 37 / 30, v = 1 },
            { s = pathUT .. "bonk.ogg", t = 68 / 30, v = 1 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "grab-polymer.ogg", t = 63 / 30, v = 1 },
    ...
    ["inspect_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "scrape.ogg", t = 70 / 30, v = 1 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 80 / 30, v = 0.8 },
