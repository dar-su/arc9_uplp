...
SWEP.WorldModelOffset = {
    ...
    TPIKPosSightOffset = Vector(2, 2.5, -5),
    -- TPIKPosReloadOffset = Vector(-5, -3, -1),
    -- TPIKAngReloadOffset = Angle(-15, -10, 10),
    TPIKPosReloadOffset = Vector(-4, -3, -2),
    TPIKAngReloadOffset = Angle(0, 0, 0),
    TPIKHolsterOffset = Vector(4, 0, -2),
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUTT .. "belt1.ogg", t = 17 / 30 },
            { s = pathUTT .. "belt2.ogg", t = 33 / 30, v = 0.5 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
        },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUTT .. "boxremove.ogg", t = 18 / 30 },
            { s = pathM249 .. "belt1.ogg", t = 30 / 30, v = 0.8 },
            { s = pathUTT .. "belt1.ogg", t = 33 / 30, v = 0.8 },
            { s = pathM249 .. "beltshake1.ogg", t = 47 / 30, v = 0.3 },
            { s = pathUTT .. "boxinsert.ogg", t = 66 / 30 },
            { s = pathUTT .. "belt2.ogg", t = 85 / 30, v = 0.8 },
            { s = pathM249 .. "beltadjust.ogg", t = 86 / 30, v = 0.8 },
            { s = pathUTT .. "lidclose.ogg", t = 120 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 130 / 30, v = 0.8 },
            { s = pathUTT .. "belt2.ogg", t = 131 / 30, v = 0.25 },
            { s = pathUTC .. "shoulder_heavy.ogg", t = 142 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathM249 .. "beltadjust.ogg", t = 86 / 30, v = 0.8 },
            { s = pathUTT .. "lidclose.ogg", t = 120 / 30, v = 0.8 },
            { s = pathUTT .. "belt1.ogg", t = 123 / 30, v = 0.25 },
            { s = pathUTT .. "chback.ogg", t = 132.5 / 30, v = 0.8 },
            { s = pathUTT .. "chforward.ogg", t = 142.5 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 155 / 30, v = 0.8 },
            { s = pathUTT .. "belt2.ogg", t = 156 / 30, v = 0.25 },
            { s = pathUTC .. "shoulder_heavy.ogg", t = 157 / 30 - 0.07, v = 0.3 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUTT .. "belt1.ogg", t = 78 / 30, v = 0.4 },
            { s = pathUTT .. "belt2.ogg", t = 82 / 30, v = 0.2 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 75 / 30, v = 0.8 },
            -- { s = pathUT .. "chback.ogg", t = 91 / 30 },
            -- { s = pathUT .. "chamber.ogg", t = 118 / 30 },
            { s = pathUTT .. "belt2.ogg", t = 145 / 30, v = 0.5 },
            -- { s = pathM249 .. "beltshake1.ogg", t = 140 / 30, v = 0.1 },
            { s = pathUTC .. "cloth_3.ogg", t = 150 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-03.ogg", t = 147.5 / 30, v = 0.8 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.05, lhik = 1 },
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        DefaultIcon = Material(defatt2 .. "pkmbar.png", "mips smooth"),
        Bone = "body",
        Pos = Vector(0, -1.1, 10),
        Ang = Angle(90, 90, 180),
    ...
    },
    {
        ...
        DefaultIcon = Material(defatt2 .. "pkmstock.png", "mips smooth"),
        Bone = "body",
        Pos = Vector(0, 0, 0),
