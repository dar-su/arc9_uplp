...
local additionalHipFireRecoilSpread = 0.018
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 15 / 60 + 0.28, c = ca },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "slide_rel.ogg", t = 40 / 60, c = ca },
    ...
    ["reload_ext"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 25 / 60 + 0.28, c = ca },
    ...
    ["reload_empty_ext"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout_empty.ogg", t = 2 / 60, c = ca },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 6 / 60, v = 0.3 },
            { s = pathRZ .. "magin.ogg", t = 27.5 / 60 + 0.28, c = ca },
