...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 4.5 / 30 - 0.1 },
            { s = pathRZ .. "chforward.ogg", t = 9 / 30 },
    ...
    ["ready_sr3"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 4.5 / 30 + 0.5 - 0.1 },
            { s = pathRZ .. "chforward.ogg", t = 9 / 30 + 0.5 },
            { s = pathUTC .. "cloth_4.ogg", t = 35 / 60 + 0.5 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.001, lhik = 0 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magrelease.ogg", t = 8 / 30, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 10 / 30 },
            { s = pathRZAK .. "magout.ogg", t = 11 / 30 },
            { s = pathUT .. "magin.ogg", t = 17 / 30, v = 0.8 },
            { s = UTCrattle, t = 22.5 / 30, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZAK .. "magout.ogg", t = 11 / 30 },
            { s = pathUT .. "magin.ogg", t = 17 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 36 / 30 - 0.1 },
            { s = pathRZ .. "chforward.ogg", t = 41 / 30 },
            { s = UTCrattle, t = 50 / 30, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_30"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 0.0, v = 0.6 },
            { s = pathUT .. "reload_start.ogg", t = 0.025, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 12 / 30, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 14 / 30 },
            { s = pathRZAK .. "magout.ogg", t = 15 / 30 },
            { s = pathUT .. "magin.ogg", t = 25 / 30, v = 0.8 },
            { s = UTCrattle, t = 22.5 / 30, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.88}
    ...
    ["reload_empty_30"] = {
        ...
        EventTable = {
            ...
            { s = pathRZAK .. "magout.ogg", t = 15 / 30 },
            { s = pathUT .. "magin.ogg", t = 25 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 46 / 30 - 0.1 },
            { s = pathRZ .. "chforward.ogg", t = 53 / 30 },
            { s = UTCrattle, t = 60 / 30, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.88}
        },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "presscheck_1.ogg", t = 90 / 30, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 115 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_2.ogg", t = 122 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 127.5 / 30, v = 0.8 },
            -- {hide = 1, t = 0},
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
    ...
    ["fix"] = {
        ...
        EventTable = {
            { s = mechh, t = 0 },
            { s = pathUTC .. "cloth_2.ogg", t = 2 / 30 + 0.25, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 5 / 30 + 0.25, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 17 / 30 + 0.25 - 0.1 },
            { s = pathRZ .. "chforward.ogg", t = 23 / 30 + 0.25 },
            { s = pathUTC .. "cloth_2.ogg", t = 29 / 30 + 0.25, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 30 / 30 + 0.25, v = 0.8 },
            -- {hide = 1, t = 0},
        },
        EjectAt = 1,
        IKTimeLine = {
