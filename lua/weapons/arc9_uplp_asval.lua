...
SWEP.Animations = {
    ...
    ["ready_sr3"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 4.5 / 30 + 0.5 - 0.1, v = 1 },
            { s = pathRZ .. "chforward.ogg", t = 9 / 30 + 0.5, v = 1 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 10 / 30, v = 1 },
            { s = pathRZAK .. "magout.ogg", t = 11 / 30, v = 1 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZAK .. "magout.ogg", t = 11 / 30, v = 1 },
            { s = pathUT .. "magin.ogg", t = 17 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 36 / 30 - 0.1, v = 1 },
            { s = pathRZ .. "chforward.ogg", t = 41 / 30, v = 1 },
    ...
    ["reload_30"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 14 / 30, v = 1 },
            { s = pathRZAK .. "magout.ogg", t = 15 / 30, v = 1 },
    ...
    ["reload_empty_30"] = {
        ...
        EventTable = {
            ...
            { s = pathRZAK .. "magout.ogg", t = 15 / 30, v = 1 },
            { s = pathUT .. "magin.ogg", t = 25 / 30, v = 0.8 },
            { s = pathRZ .. "chback.ogg", t = 46 / 30 - 0.1, v = 1 },
            { s = pathRZ .. "chforward.ogg", t = 53 / 30, v = 1 },
    ...
    ["fix"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 17 / 30 + 0.25 - 0.1, v = 1 },
            { s = pathRZ .. "chforward.ogg", t = 23 / 30 + 0.25, v = 1 },
