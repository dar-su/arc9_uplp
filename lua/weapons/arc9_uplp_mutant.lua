...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/stg/chback.ogg", t = 8 / 30 - 0.1, v = 1 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 13 / 30, v = 1 },
            { s = pathUTC .. "cloth_4.ogg", t = 1132 / 60, v = 0.6 },
        },
        IKTimeLine = {
            { t = 0.0, lhik = 0 },
            { t = 0.5, lhik = 0 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 11 / 30, v = 1 },
            { s = pathUT .. "magin.ogg", t = 18 / 30, v = 0.8 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 11 / 30, v = 1 },
            { s = pathUT .. "magin.ogg", t = 18 / 30, v = 0.8 },
            { s = ")uplp_rz/stg/chback.ogg", t = 36 / 30, v = 1 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 39.5 / 30 + 0.12, v = 1 },
    ...
    ["reload_40rnd"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 0.0, v = 0.6 },
            { s = pathUT .. "reload_start.ogg", t = 0.025, v = 0.8 },
            { s = pathUT .. "magrelease.ogg", t = 8 / 30 + 0.05, v = 0.8 },
            { s = pathUT .. "bonk.ogg", t = 10 / 30 + 0.05, v = 1 },
            { s = pathRZ .. "magout.ogg", t = 11 / 30 + 0.05, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30, v = 0.8 },
            { s = UTCrattle, t = 40 / 30, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_empty_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 11 / 30 + 0.05, v = 1 },
            { s = pathUT .. "magin.ogg", t = 22 / 30, v = 0.8 },
            { s = ")uplp_rz/stg/chback.ogg", t = 42 / 30 + 0.05, v = 0.8 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 45.5 / 30 + 0.18, v = 0.8 },
            { s = UTCrattle, t = 55 / 30, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
        },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin_drum.ogg", t = 42 / 30, v = 1 },
    ...
    ["reload_empty_drum"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/stg/chback.ogg", t = 69 / 30 - 0.1, v = 0.8 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 71 / 30, v = 0.8 },
...
SWEP.AttachmentElements = {
    ...
    ["uplp_ak_mag_545_45p"] = { Bodygroups = { { 7, 22 } } },
