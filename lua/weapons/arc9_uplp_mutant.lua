...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/stg/chback.ogg", t = 8 / 30 - 0.1 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 13 / 30 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 11 / 30 },
            { s = pathUT .. "magin.ogg", t = 18 / 30, v = 0.8 },
            { s = ")uplp_rz/stg/chback.ogg", t = 36 / 30 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 39.5 / 30 + 0.12 },
    ...
    ["reload_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "bonk.ogg", t = 10 / 30 + 0.05 },
            { s = pathRZ .. "magout.ogg", t = 11 / 30 + 0.05 },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magin_drum.ogg", t = 42 / 30 },
