...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_rz/stg/chback.ogg", t = 3 / 30 - 0.1, c = ca, v = 1 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 9 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magin.ogg", t = 18 / 30, c = ca, v = 0.8 },
            { s = ")uplp_rz/stg/chback.ogg", t = 36 / 30 - 0.1, c = ca, v = 1 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 39.5 / 30, c = ca, v = 1 },
    ...
    ["reload_empty_40rnd"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 9 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magin.ogg", t = 20 / 30, c = ca, v = 0.8 },
            { s = ")uplp_rz/stg/chback.ogg", t = 42 / 30 - 0.1, c = ca, v = 0.8 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 45.5 / 30, c = ca, v = 0.8 },
    ...
    ["reload_empty_545"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "magout.ogg", t = 9 / 30, c = ca, v = 0.8 },
            { s = pathUT .. "magin.ogg", t = 18 / 30, c = ca, v = 0.8 },
            { s = ")uplp_rz/stg/chback.ogg", t = 36 / 30 - 0.1, c = ca, v = 0.8 },
            { s = ")uplp_rz/stg/chamber.ogg", t = 39.5 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 50 / 30, c = ca, v = 0.8 },
            {hide = 1, t = 0},
            {hide = 0, t = 0.29},
            {hide = 2, t = 0.75}
