...
SWEP.ShellModel = "models/weapons/arc9/uplp/shells/shell_47.mdl"
SWEP.ShellScale = 1.2
SWEP.ShellPitch = 90
...
SWEP.DamageMin = 10 -- Damage dealt after maximum range
...
SWEP.RangeMax = 25 * 39.37 -- How far in M the bullets need to go to deal DamageMin
