...
SWEP.CustomizePos = Vector(16, 35, 5)
...
SWEP.TriggerDownSound = {pathREALLYREAL .. "trigger1.wav"}

SWEP.TriggerUpSound = {pathREALLYREAL .. "trigger2.wav"}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathREALLYREAL .. "magin.ogg", t = 28 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 32 / 30, v = 0.6 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathREALLYREAL .. "chback.ogg", t = 45.5 / 30, v = 0.8 },
            { s = pathREALLYREAL .. "chforward.ogg", t = 51 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 58 / 30, v = 0.6 },
    ...
    ["reload_20"] = {
        ...
        EventTable = {
            ...
            { s = pathREALLYREAL .. "magin.ogg", t = 21 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 28 / 30, v = 0.6 },
    ...
    ["reload_empty_20"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 9 / 30, v = 0.6 },
            { s = pathREALLYREAL .. "magin.ogg", t = 21 / 30, v = 0.8 },
            { s = pathREALLYREAL .. "chforward.ogg", t = 39 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 44 / 30, v = 0.6 },
    ...
    ["reload_40"] = {
        ...
        EventTable = {
            ...
            { s = pathREALLYREAL .. "magin.ogg", t = 39 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 52 / 30, v = 0.6 },
    ...
    ["reload_empty_40"] = {
        ...
        EventTable = {
            ...
            { s = pathREALLYREAL .. "chback.ogg", t = 62 / 30, v = 0.8 },
            { s = pathREALLYREAL .. "chforward.ogg", t = 68 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 75 / 30, v = 0.6 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathREALLYREAL .. "chback.ogg", t = 88 / 30, v = 0.5 },
            { s = pathUT5 .. "chlock.ogg", t = 114 / 30, v = 1 },
            { s = pathUTC .. "cloth_3.ogg", t = 123 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-03.ogg", t = 130 / 30, v = 0.6 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.15, lhik = 0 },
    ...
    ["inspect_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "cloth_2.ogg", t = 70 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 67 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_3.ogg", t = 108 / 30, v = 0.8 },
