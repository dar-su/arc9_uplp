...
-- Damage
SWEP.DamageMax = 70 * ARC9.UPLP_ShotgunDamageMaxModifier
...
SWEP.DispersionSpreadAddHipFire = 0.008

SWEP.DispersionSpreadAddRecoil = 0.04
SWEP.DispersionSpreadAddMove = 0.008
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUTREAL .. "rack_1.ogg", t = 5 / 30, v = 0.8 },
            { s = pathUTREAL .. "rack_2.ogg", t = 17 / 30, v = 0.8 },
            { s = pathUTC .. "shoulder_med.ogg", t = 39 / 60 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.01, lhik = 0 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUTM82 .. "magrel.ogg", t = 5 / 30, v = 0.8 },
            { s = pathUTSaiga .. "magout.ogg", t = 12 / 30, v = 0.8 },
            -- { s = pathUTM82 .. "magout.ogg", t = 12 / 30, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 28 / 30, v = 0.6 },
            { s = pathUTM82 .. "struggle.ogg", t = 41 / 30, v = 0.8 },
            { s = pathUTM82 .. "magin.ogg", t = 45 / 30, v = 0.8 },
            -- { s = pathUTSaiga .. "magin.ogg", t = 43 / 30, v = 0.8 },
            { s = pathUTC .. "shoulder_med.ogg", t = 55 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 60 / 30, v = 0.8 },
    ...
    ["reload_6"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch.ogg", t = 28 / 30, v = 0.6 },
            -- { s = pathUTM82 .. "struggle.ogg", t = 41 / 30, v = 0.8 },
            { s = pathUTM82 .. "magin.ogg", t = 42 / 30, v = 0.8 },
            -- { s = pathUTSaiga .. "magin.ogg", t = 43 / 30, v = 0.8 },
            { s = pathUTC .. "shoulder_med.ogg", t = 55 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 60 / 30, v = 0.8 },
    ...
    ["reload_10"] = {
        ...
        EventTable = {
            ...
            { s = pathUTM82 .. "magrel.ogg", t = 6 / 30, v = 0.8 },
            { s = pathUTSaiga .. "magout.ogg", t = 11 / 30, v = 0.8 },
            -- { s = pathUTM82 .. "magout.ogg", t = 16 / 30, v = 0.8 },
            { s = pathUTC .. "magpouch.ogg", t = 32 / 30, v = 0.6 },
            { s = pathUTM82 .. "struggle.ogg", t = 50 / 30, v = 0.8 },
            { s = pathUTM82 .. "magin.ogg", t = 55 / 30, v = 0.8 },
            -- { s = pathUTSaiga .. "magin.ogg", t = 58 / 30, v = 0.8 },
            { s = pathUTC .. "shoulder_med.ogg", t = 66 / 30, v = 0.8 },
    ...
    ["reload_empty_10"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "shoulder_med.ogg", t = 90 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 92 / 30, v = 0.8 },
    ...
    ["reload_start_empty"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_urban_temp/spas12/breechload.ogg", t = 22 / 30 },
    ...
    ["reload_finish_emptyalt"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "shoulder_med.ogg", t = 21 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 25 / 30, v = 0.8 },
        },
        IKTimeLine = {
            { t = 0, lhik = 0 },
            { t = 0.01, lhik = 0 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUTREAL .. "rack_1.ogg", t = 61 / 30 },
            { s = pathUTREAL .. "rack_2.ogg", t = 87 / 30 },
            { s = pathUTC .. "shoulder_med.ogg", t = 83 / 30, v = 0.8 },
    ...
    ["inspect_serbu"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "cloth_2.ogg", t = 40 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 50 / 30, v = 0.8 },
            { s = pathUTREAL .. "rack_1.ogg", t = 63 / 30 },
            { s = pathUTREAL .. "rack_2.ogg", t = 87 / 30 },
            { s = pathUTC .. "shoulder_med.ogg", t = 83 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 90 / 30, v = 0.8 },
            {hide = 1, t = 0},
