...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "movement-shotgun-03.ogg", t = 57 / 30, v = 1 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUTREAL .. "rack_1.ogg", t = 61 / 30, v = 1 },
            { s = pathUTREAL .. "rack_2.ogg", t = 87 / 30, v = 1 },
    ...
    ["inspect_serbu"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "cloth_2.ogg", t = 40 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 50 / 30, v = 0.8 },
            { s = pathUTREAL .. "rack_1.ogg", t = 63 / 30, v = 1 },
            { s = pathUTREAL .. "rack_2.ogg", t = 87 / 30, v = 1 },
            { s = pathUTC .. "shoulder_med.ogg", t = 83 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 90 / 30, v = 0.8 },
            {hide = 1, t = 0},
