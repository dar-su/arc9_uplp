...
SWEP.Credits = {
    ...
    [ ARC9:GetPhrase( "uplp_assets" ) ] = "TastyTony, Darsu, notcplkerry",
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        Source = {"reload_empty", "reload_empty_2"},
        MinProgress = 0.85,
        PeekProgress = 0.775,
        RefillProgress = 0.65,
        FireASAP = true,
    ...
    ["reload_10"] = {
        ...
        EventTable = {
            ...
            --{ s = pathRZ .. "struggle.ogg", t = 21 / 30 - 0.25 },
            { s = pathRZ .. "magin.ogg", t = 23 / 30 - 0.25 },
    ...
    ["reload_20"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 4 / 30 },
            { s = UTCrattle, t = 0, v = 0.8 },
            { s = pathRZ .. "magout.ogg", t = 3 / 30 },
            { s = pathRZ .. "struggle.ogg", t = 24 / 30 - 0.3 },
            { s = pathRZ .. "magin.ogg", t = 26 / 30 - 0.3 },
    ...
    ["reload_40"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch.ogg", t = 4 / 30 },
            { s = pathRZ .. "struggle.ogg", t = 17 / 30 + 5 / 30 },
            { s = pathRZ .. "magin.ogg", t = 21 / 30 + 5 / 30 },
    ...
    ["reload_empty_40"] = {
        Source = {"reload_empty40", "reload_empty40_2"},
        MinProgress = 0.85,
        PeekProgress = 0.775,
        RefillProgress = 0.7,
        FireASAP = true,
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 21 / 30 + 5 / 30 },
            { s = UTCloth, t = 20 / 30 + 5 / 30, v = 0.25 },
            { s = pathRZ .. "boltrel.ogg", t = 36 / 30 + 5 / 30 },
    ...
    ["reload_60"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "struggle.ogg", t = 16 / 30 + 9 / 30 },
            { s = pathRZ .. "magin.ogg", t = 21 / 30 + 10 / 30 },
    ...
    ["reload_empty_60"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 21 / 30 + 10 / 30 },
            { s = UTCloth, t = 20 / 30 + 5 / 30, v = 0.25 },
            { s = pathRZ .. "bolt1.ogg", t = 44 / 30, v = 0.8 },
            { s = pathRZ .. "bolt2.ogg", t = 50 / 30, v = 0.8 },
    ...
    ["reload_100"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 28 / 30 - 0.1 },
