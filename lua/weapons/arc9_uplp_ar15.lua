...
"[Survivor]"
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "chback.ogg", t = 3 / 30, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 9 / 30, v = 0.8 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.25 },
            { s = UTCloth, t = 20 / 30, v = 0.25 },
            { s = UTCloth, t = 30 / 30 - 0.07, v = 0.25 },
            { s = b2i, t = 32 / 30, v = 1 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout.ogg", t = 5 / 30 },
            { s = pathRZ .. "struggle.ogg", t = 25 / 30 - 0.25 },
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.3 },
            { s = UTCloth, t = 25 / 30, v = 0.8 },
            { s = pathRZ .. "boltrel.ogg", t = 32 / 30 },
    ...
    ["reload_empty_10"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.25 },
            { s = UTCloth, t = 22 / 30, v = 0.8 },
            { s = pathRZ .. "boltrel.ogg", t = 28 / 30 + 0.03 },
            { s = UTCloth, t = 39 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_40"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "struggle.ogg", t = 25 / 30 - 0.25 },
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.25 },
            { s = UTCloth, t = 31 / 30, v = 0.8 },
            { s = UTCloth, t = 37 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty_40"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.25 },
            { s = UTCloth, t = 31 / 30, v = 0.8 },
            { s = pathRZ .. "boltrel.ogg", t = 38 / 30 - 0.1 },
            { s = UTCloth, t = 48 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_60"] = {
        ...
        EventTable = {
            ...
            { s = UTCrattle, t = 0 / 30, v = 0.8 },
            { s = pathRZ .. "magout.ogg", t = 5 / 30 },
            { s = pathRZ .. "struggle.ogg", t = 25 / 30 - 0.12 },
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.05 },
            { s = UTCloth, t = 36 / 30, v = 0.8 },
            { s = UTCloth, t = 42 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty_60"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "struggle.ogg", t = 25 / 30 - 0.12 },
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.05 },
            { s = UTCloth, t = 35 / 30, v = 0.8 },
            { s = pathRZ .. "boltrel.ogg", t = 41 / 30 },
            { s = UTCloth, t = 53 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_100"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.1 },
            { s = ")uplp_urban_temp/ak/bonk.ogg", t = 37.0 / 30, v = 0.75 },
            { s = ")uplp_urban_temp/ak/presscheck_1.ogg", t = 31.33 / 30, v = 0.8 },
            { s = UTCloth, t = 55 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty_100"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "struggle.ogg", t = 25 / 30 - 0.2 },
            { s = pathRZ .. "magin.ogg", t = 30 / 30 - 0.1 },
            { s = pathUT .. "chback.ogg", t = 42.5 / 30, v = 0.8 },
            { s = pathUT .. "chamber.ogg", t = 48 / 30, v = 0.8 },
            { s = UTCloth, t = 56 / 30, v = 0.8 },
            { s = UTCloth, t = 64 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_g17"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 4 / 30, v = 0.4 },
            { s = UTCrattle, t = 0 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/scar9/magout-9.ogg", t = 5 / 30, v = 0.8 },
    ...
    ["reload_g33"] = {
        ...
        EventTable = {
            ...
            { s = UTCrattle, t = 0 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/scar9/magout-9.ogg", t = 5 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/scar9/magin-9.ogg", t = 19 / 30 + 0.15, v = 0.8 },
            { s = UTCloth, t = 25 / 30, v = 0.8 },
            { s = UTCloth, t = 32 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_g50"] = {
        ...
        EventTable = {
            ...
            { s = UTCrattle, t = 0 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/scar9/magout-9.ogg", t = 5 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/mp7/scar9/magin-9.ogg", t = 28 / 30, v = 0.8 },
            { s = UTCloth, t = 35 / 30, v = 0.8 },
            { s = UTCloth, t = 42 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty_g50"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_urban_temp/mp7/scar9/magin-9.ogg", t = 28 / 30, v = 0.8 },
            { s = UTCloth, t = 35 / 30, v = 0.8 },
            { s = pathRZ .. "boltrel.ogg", t = 42 / 30 + 0 },
            { s = UTCloth, t = 52 / 30 - 0.07, v = 0.3 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = UTCrattle, t = 5 / 30, v = 0.3 },
            { s = UTCloth, t = 57 / 30, v = 0.8 },
            { s = UTCrattle, t = 110 / 30, v = 0.2 },
            { s = UTCrattle, t = 130 / 30, v = 0.8 },
            { s = UTCloth, t = 135 / 30, v = 0.4 },
            -- {hide = 1, t = 0},
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
