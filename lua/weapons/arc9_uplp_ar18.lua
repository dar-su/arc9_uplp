...
SWEP.ShootSound = {
    pathREAL .. "fire-01.wav",
    pathREAL .. "fire-02.wav",
    pathREAL .. "fire-03.wav",
}
...
local mechh = {
    pathREAL .. "mech-01.wav",
    pathREAL .. "mech-02.wav",
    pathREAL .. "mech-03.wav",
    pathREAL .. "mech-04.wav",
}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathREAL .. "magout.ogg", t = 5 / 30, v = 0.8 },
            { s = pathREAL .. "magin.ogg", t = 19 / 30 - 0.25, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 25 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 32 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "chback.ogg", t = 37 / 30, v = 0.3 },
            { s = pathUT .. "boltdrop.ogg", t = 43 / 30, v = 0.8 },
    ...
    ["reload_20"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 4 / 30, v = 0.4 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 0 / 30, v = 0.8 },
            { s = pathREAL .. "magout.ogg", t = 3 / 30, v = 0.8 },
            { s = pathREAL .. "magin.ogg", t = 16 / 30 - 0.25, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 25 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 32 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty_20"] = {
        ...
        EventTable = {
            ...
            { s = pathREAL .. "magin.ogg", t = 16 / 30 - 0.25, v = 0.8 },
            { s = pathUTC .. "cloth_1.ogg", t = 25 / 30, v = 0.8 },
            { s = pathUT .. "chback.ogg", t = 33 / 30, v = 0.3 },
            { s = pathUT .. "boltdrop.ogg", t = 38 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 40 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_40"] = {
        ...
        EventTable = {
            { s = pathUTC .. "magpouch.ogg", t = 4 / 30, v = 0.4 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 0 / 30, v = 0.8 },
            { s = pathREAL .. "magout.ogg", t = 7 / 30, v = 0.8 },
            { s = pathREAL .. "magin.ogg", t = 26 / 30 - 0.25, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 31 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 37 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_empty_40"] = {
        ...
        EventTable = {
            ...
            { s = pathREAL .. "magout.ogg", t = 7 / 30, v = 0.8 },
            { s = pathREAL .. "magin.ogg", t = 26 / 30 - 0.25, v = 0.8 },
            { s = pathUTC .. "cloth_1.ogg", t = 31 / 30, v = 0.8 },
            { s = pathUT .. "chback.ogg", t = 49 / 30, v = 0.3 },
            { s = pathUT .. "boltdrop.ogg", t = 55 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_4.ogg", t = 52 / 30 - 0.07, v = 0.3 },
    ...
    ["inspect_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "cloth_2.ogg", t = 70 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 75 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_3.ogg", t = 100 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-03.ogg", t = 110 / 30, v = 0.8 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.15, lhik = 0 },
