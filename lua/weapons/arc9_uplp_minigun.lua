...
SWEP.WorldModelOffset = {
    ...
    TPIKPos = Vector(-8, 6, -8),
    TPIKAng = Angle(-12, -0, 180),
    Scale = 1,

    TPIKPosSightOffset = Vector(2, 4, -4),
    TPIKHolsterOffset = Vector(2, -2, 7),
}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "cloth_4.ogg", t = 110 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-04.ogg", t = 115 / 30, v = 0.8 },
