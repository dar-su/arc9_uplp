...
SWEP.Animations = {
    ...
    ["reload_20"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magout_pistol.ogg", t = 10 / 30, c = ca, v = 1 },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 24 / 30, v = 0.6 },
            { s = pathRZ .. "magplace.ogg", t = 36 / 30, c = ca, v = 1 },
            { s = pathRZ .. "magin_pistol.ogg", t = 39 / 30, c = ca, v = 1 },
    ...
    ["reload_empty_20"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "magrel.ogg", t = 53 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chforward.ogg", t = 55 / 30, c = ca, v = 0.8 },
