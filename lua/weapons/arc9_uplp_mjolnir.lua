...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chback.ogg", t = 0 / 30, v = 1 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_urban_temp/m82/magrel.ogg", t = 0 / 30, v = 0.8 },
            { s = pathRZ .. "magout.ogg", t = 0 / 30, v = 0.8 },
            { s = pathRZ .. "struggle.ogg", t = 14 / 30, v = 0.8 },
            { s = pathRZ .. "magin.ogg", t = 13 / 30, v = 0.8 },
            { s = pathRZ .. "magseat.ogg", t = 26.5 / 30, v = 0.8 },
            { s = UTCloth, t = 20 / 30, v = 0.6 },
            { s = touchh, t = 37.5 / 30, v = 0.3 },
            { s = b2i, t = 34 / 30 - 0.07, v = 0.3 },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            ...
            { s = UTCrattle, t = 0 / 30, v = 0.8 },
            { s = ")uplp_urban_temp/m82/magrel.ogg", t = 0 / 30, v = 0.8 },
            { s = pathRZ .. "magout.ogg", t = 0 / 30 + 0.15, v = 0.8 },
            { s = pathRZ .. "struggle.ogg", t = 14 / 30 + 0.3, v = 0.8 },
            { s = pathRZ .. "magin.ogg", t = 13 / 30 + 0.3, v = 0.8 },
            { s = pathRZ .. "magseat.ogg", t = 28 / 30 + 0.3, v = 0.8 },
            { s = UTCloth, t = 25 / 30 + 0.3, v = 0.8 },
            { s = touchh, t = 40 / 30 + 0.3, v = 0.3 },
            { s = b2i, t = 32 / 30 + 0.3, v = 0.3 },
    ...
    ["inspect"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "movement-rifle-02.ogg", t = 48 / 30, v = 0.8 },
            { s = pathUTC .. "cloth_2.ogg", t = 89 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-03.ogg", t = 126 / 30, v = 0.8 },
            { s = pathUTC .. "movement-rifle-02.ogg", t = 133 / 30, v = 0.8 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.26, lhik = 1 },
