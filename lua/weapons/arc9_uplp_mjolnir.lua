...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chforward.ogg", t = 2 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "chamber.ogg", t = 2 / 30, c = ca, v = 0.8 },
            { s = UTCrattle, t = 18 / 30, c = ca, v = 0.6 },
        },
        IKTimeLine = {
            { t = 0, lhik = 1 },
            { t = 0.15, lhik = 0 },
    ...
    ["reload"] = {
        ...
        EventTable = {
            ...
            { s = ")uplp_urban_temp/m82/magrel.ogg", t = 0 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "magout.ogg", t = 0 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "struggle.ogg", t = 14 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "magin.ogg", t = 13 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "magseat.ogg", t = 26.5 / 30, c = ca, v = 0.8 },
            { s = UTCloth, t = 20 / 30, c = ca, v = 0.6 },
            { s = touchh, t = 37.5 / 30, c = ca, v = 0.3 },
            { s = b2i, t = 34 / 30 - 0.07, c = ca, v = 0.3 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "struggle.ogg", t = 14 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "magin.ogg", t = 13 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "magseat.ogg", t = 25 / 30, c = ca, v = 0.8 },
            { s = UTCloth, t = 25 / 30, c = ca, v = 0.6 },
            { s = pathRZ .. "chunlock.ogg", t = 37 / 30, c = ca, v = 1 },
            { s = pathRZ .. "chamber.ogg", t = 30 / 30, c = ca, v = 1 },
            { s = touchh, t = 26 / 30, c = ca, v = 0.3 },
            { s = b2i, t = 50 / 30 - 0.07, c = ca, v = 0.3 },
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
            ...
            { s = UTCrattle, t = 0 / 30, c = ca, v = 0.8 },
            { s = ")uplp_urban_temp/m82/magrel.ogg", t = 0 / 30, c = ca, v = 0.8 },
            { s = pathRZ .. "magout.ogg", t = 0 / 30 + 0.15, c = ca, v = 0.8 },
            { s = pathRZ .. "struggle.ogg", t = 14 / 30 + 0.3, c = ca, v = 0.8 },
            { s = pathRZ .. "magin.ogg", t = 13 / 30 + 0.3, c = ca, v = 0.8 },
            { s = pathRZ .. "magseat.ogg", t = 28 / 30 + 0.3, c = ca, v = 0.8 },
            { s = UTCloth, t = 25 / 30 + 0.3, c = ca, v = 0.8 },
            { s = touchh, t = 40 / 30 + 0.3, c = ca, v = 0.3 },
            { s = b2i, t = 32 / 30 + 0.3, c = ca, v = 0.3 },
    ...
    ["reload_empty_drum"] = {
        ...
        EventTable = {
            ...
            { s = pathRZ .. "chamber.ogg", t = 32 / 30 + 0.3, c = ca, v = 1 },
            { s = touchh, t = 38 / 30 + 0.3, c = ca, v = 0.3 },
            { s = b2i, t = 47 / 30 + 0.3, c = ca, v = 0.3 },
