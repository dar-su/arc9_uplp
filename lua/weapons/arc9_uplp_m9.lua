...
SWEP.ShootSound = {
    path1911 .. "fire-9-01.wav",
    path1911 .. "fire-9-02.wav",
    path1911 .. "fire-9-03.wav",
}


SWEP.ShootSoundSilenced = {
    path1911 .. "fire-9-sup-01.wav",
    path1911 .. "fire-9-sup-02.wav",
    path1911 .. "fire-9-sup-03.wav",
}
...
local mechh = {
    path1911 .. "mech-01.wav",
    path1911 .. "mech-02.wav",
    path1911 .. "mech-03.wav",
    path1911 .. "mech-04.wav",
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = pathUT .. "sliderel.ogg", t = 15 / 60, v = 0.8 },
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 20 / 60, v = 0.3 },
            { s = pathUT .. "magin.ogg", t = 35 / 60 },
            { s = pathUT .. "sliderel.ogg", t = 60 / 60 },
            { s = UTCrattle, t = 67.5 / 60 },
            {hide = 0, t = 0},
            {hide = 1, t = 0.4},
            {hide = 0, t = 0.6},
        },
    ...
    ["reload_empty_ext"] = {
        ...
        EventTable = {
            ...
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 20 / 60, v = 0.3 },
            { s = pathUT .. "magin.ogg", t = 45 / 60 },
            { s = pathUT .. "sliderel.ogg", t = 67.5 / 60 },
            { s = UTCrattle, t = 75 / 60 },
            {hide = 0, t = 0},
            {hide = 1, t = 0.5},
            {hide = 0, t = 0.75},
    ...
    ["rc_reload"] = {
        ...
        EventTable = {
            { s = pathUTC .. "pistol_rattle_2.ogg", t = 0 / 60 },
            { s = pathUT .. "magout.ogg", t = 7.5 / 60 },
            { s = pathUTC .. "magpouch_pull_small.ogg", t = 20 / 60, v = 0.3 },
            { s = pathUT .. "magin.ogg", t = 30 / 60 },
            { s = UTCrattle, t = 30 / 60 },
            {hide = 0, t = 0},
            {hide = 1, t = 0.4/1.12},
            {hide = 0, t = 0.53},
